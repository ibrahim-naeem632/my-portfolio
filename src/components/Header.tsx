                ...
                <div className="mx-auto max-w-[1200px] px-6">
                    <div className="flex h-9 items-center justify-between">
                        <div className="flex items-center gap-6">
                            <a href="tel:+923000000000" className="flex items-center gap-2">
                                <FaPhoneAlt size={13} /> +92 300 0000000
                            </a>
                            <a href="mailto:hello@yourstudio.com" className="flex items-center gap-2">
                                <FaEnvelope size={13} /> hello@yourstudio.com
                            </a>
                        </div>
